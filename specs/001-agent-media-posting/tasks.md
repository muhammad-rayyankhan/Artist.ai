...
- [ ] T002 Initialize backend Node.js project with TypeScript, Express, Prisma dependencies in backend/
- [ ] T003 Initialize frontend Next.js project with React dependencies in frontend/
